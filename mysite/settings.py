...
# Find the directory that the file is located in.
#SETTINGS_DIR = os.path.dirname(__file__)
# Find the root directory of our project.
#PROJECT_PATH = os.path.join(SETTINGS_DIR, os.pardir)
# Get the absolute path to our project's root.
#PROJECT_PATH = os.path.abspath(PROJECT_PATH)
TEMPLATE_PATH = os.path.join(BASE_DIR, 'templates')
DATABASE_PATH = os.path.join(BASE_DIR, 'cms.db')

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/1.9/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = '+x+8d6=25m)**s6ko_4b_&ye+h%(wf+=zahq7js9rz@l%mf88('
